...
export const Logo: React.FC<IconSvgProps> = ({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <rect fill={isLight ? "#ffffff" : "#000000"} height="300" width="300" />

      <g transform={`translate(1, 20)`}>
        <rect
          fill={isLight ? "#1e6091" : "#ffffff"}
          height="100"
          rx="10"
          width="140"
          x="30"
          y="30"
        />
        <rect fill="#1e6091" height="20" rx="10" width="140" x="30" y="30" />
        <circle cx="45" cy="40" fill="#ff6b6b" r="5" />
        <circle cx="60" cy="40" fill="#feca57" r="5" />
        <circle cx="75" cy="40" fill="#48dbfb" r="5" />

        <rect
          fill={isLight ? "#ffffff" : "#1e6091"}
          height="10"
          rx="2"
          width="60"
          x="40"
        ...
        <rect
          ...
          y="60"
        />
        <rect fill="#ffffff" height="5" rx="2" width="40" x="115" y="65" />
        <rect fill="#ffffff" height="5" rx="2" width="30" x="115" y="75" />
        <rect fill="#ffffff" height="5" rx="2" width="20" x="115" y="85" />
      </g>
    </svg>
  );
};
...
export const ComputadoraIcon: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export const DesingIcon: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export const ServidorIcon: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
